<template>
    <div class="box  m-auto mt-10 p-4 w-40  rounded-md     ">
        ...
        <div class=" flex ml-4 ">
           <div class=" text-sm/[17px] mt-1  font-sans ">
            <b class="">
                {{titlee}}
            </b>
             <br>
          ...
          <div @click="onClickAdd">
            <svg class="cursor-pointer hover:w-10 active:w-8 " width="40px" height="40px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
